...
const DUMMY_DATA = [
  {
    servers: [
      { id: 1, type: 1, name: "Direct Messages", img: "conflictlogo.png" },
      {
        ...
        img: "fallout.png",
        channels: [
          {id:1, title: "Welcome", subs: [{id:1, title: "Announcements"}, {id: 2, title: "Introduce Yourself"}]},
          {id:2, title: "Channel 1", subs: [{id:1, title: "Announcements"}, {id: 2, title: "Introduce Yourself"}]},
          {id:3, title: "Channel 2", subs: [{id:1, title: "Announcements"}, {id: 2, title: "Introduce Yourself"}]},
        ],
        members: [],
        messages: [],
      },
